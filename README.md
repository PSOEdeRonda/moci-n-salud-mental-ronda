...
<body class="min-h-screen flex flex-col">
    ...
    <script>
        ...
        const diffusionText = `🛑 ¡El PP de Ronda ha rechazado el Plan Municipal de Salud Mental Juvenil! 7 medidas urgentes para nuestra juventud. Conoce la moción completa (Moción Salud Mental Juvenil octubre 25.pdf) y difunde.`;
